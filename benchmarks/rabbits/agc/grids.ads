...
private
   ...
   procedure AGC_Visit_Cell (X : System.Address);
   ...
   procedure AGC_Visit_Grid (X : System.Address);
   procedure AGC_Visit (X : access Grid);
   procedure AGC_Visit_Grid_Classwide (X : System.Address);
end Grids;
